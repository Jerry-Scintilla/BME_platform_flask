...
def seed():
    with app.app_context():
        ...
        # 2. 权限
        # ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
        # 权限名一律下划线，与 @check_permission('xxx_management') 对齐
        permissions_data = [
            {"name": "course_management", "description": "课程管理"},
            {"name": "user_management", "description": "用户管理"},
            {"name": "article_management", "description": "文章管理"},
            {"name": "group_management", "description": "小组管理"},
            {"name": "medal_management", "description": "勋章管理"},
            {"name": "task_management", "description": "任务管理"},
            {"name": "discussion_management", "description": "讨论区管理"},
            {"name": "checkin_management", "description": "签到管理"},
            {"name": "seat_management", "description": "座位管理"},
            {"name": "system_management", "description": "系统管理"},
            {"name": "llm_management", "description": "大模型服务管理"},
            {"name": "attendance_report_recipient", "description": "接收每日出勤汇总邮件"},
            {"name": "camp_management", "description": "营期管理"},
            {"name": "camp_attendance_view", "description": "营期考勤看板"},
            {"name": "camp_leave_approve", "description": "营期请假审批"},
            {"name": "camp_reward_issue", "description": "营期奖励发放"},
            {"name": "camp_seat_assign", "description": "营期座位分配"},
        ]
        perm_count = 0
