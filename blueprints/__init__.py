...
from .camp_announcement import bp as camp_announcement_bp
...
from .camp_material import bp as camp_material_bp
from .camp_meeting import bp as camp_meeting_bp
from .showcase import bp as showcase_bp
